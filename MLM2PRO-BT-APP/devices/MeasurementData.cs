...
namespace MLM2PRO_BT_APP.devices
{
    class MeasurementData
    {
        ...
        public OpenConnectApiMessage ConvertHexToMeasurementData(string? hexData)
        {
            ...
            CarryDistance = BitConverter.ToUInt16(bytes, 12); // carry distance?
            TotalDistance = BitConverter.ToUInt16(bytes, 14); // total distance? both seem lower than AG, but not crazy off...
